---
title: 'Hipo $1,000,000 Rewards Program'
---
...
All you need to do is provide liquidity in the following pools:
...
1. **How can I participate in the $1M rewards program, and what’s the timeline?**

The **$1M rewards program** incentivizes liquidity providers for **hGRAM** and **HPO pools on DEXs**.

- Add liquidity to any of these pools: **HPO/hGRAM**, **HPO/GRAM**, or **hGRAM/GRAM**.
- Rewards will be distributed **until the $1M is fully allocated**.
- The entire process is **on-chain and fully transparent**.

2. **Which pools are better to join?**

Each pool serves a unique purpose in strengthening the Hipo ecosystem. You can choose based on your preferences or diversify across multiple pools for maximum impact.
