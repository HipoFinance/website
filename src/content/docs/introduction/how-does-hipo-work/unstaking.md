...
2. **Initiate Unstaking**: Simply go to the [Hipo App](/unstake/) and enter the amount of Hipo Staked GRAM (hGRAM) you want to unstake.
...
Wallets that cannot sign dapp transactions can stake and unstake with plain transfers — see [Staking Without the App](/docs/staking-without-the-app/).
