...
const { wallet, sendDeposit, sendWithdraw } = useWalletStore()
                ...
                <v-window-item :value="2">
                    <v-container fluid>
                        <v-row class="justify-center">
                            ...
                            <!-- <v-row class="justify-center"> -->
                            <v-col class="d-flex v-col-3 justify-center">
                                <v-btn :loading="states.unstaking" color="#FF7E73" variant="tonal" style="margin: 10px"
                                    @click="unstake">Unstake</v-btn>
                            </v-col>
                        </v-row>
                        <v-row v-if="states.unstaked != null">
                            <div v-if="states.unstaked">Successful</div>
                            <div v-else>Failed</div>
                        </v-row>
                    </v-container>
                </v-window-item>
