...
export const LOCALES = {
  ...
  ar: { lang: 'ar', dir: 'rtl', label: 'العربية', tonconnect: 'en', status: 'indexed', intl: 'ar-u-nu-arab' },
  de: { lang: 'de', dir: 'ltr', label: 'Deutsch', tonconnect: 'en', status: 'indexed' },
  hi: { lang: 'hi', dir: 'ltr', label: 'हिन्दी', tonconnect: 'en', status: 'indexed' },
  tr: { lang: 'tr', dir: 'ltr', label: 'Türkçe', tonconnect: 'en', status: 'indexed' },
  it: { lang: 'it', dir: 'ltr', label: 'Italiano', tonconnect: 'en', status: 'indexed' },
  id: { lang: 'id', dir: 'ltr', label: 'Bahasa Indonesia', tonconnect: 'en', status: 'indexed' },
  'pt-br': { lang: 'pt-BR', dir: 'ltr', label: 'Português (Brasil)', tonconnect: 'en', status: 'indexed' },
}
